...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0b1224] text-slate-100 font-sans selection:bg-sky-500 selection:text-white">
      ...
      <section 
        id="contact" 
        className="min-h-screen flex items-center justify-center px-6 md:px-20 bg-[#0b1224] border-t border-slate-900/50 text-white"
      >
      ...
      {/* FOOTER */}
      <footer className="bg-[#090d1a] border-t border-slate-900 py-8 text-center text-sm text-slate-500 relative">
        <div className="max-w-7xl mx-auto px-6 md:px-20 flex flex-col md:flex-row items-center justify-between gap-4">
          
          {/* Copyright text */}
          <div>
            <p>© {new Date().getFullYear()} Midhuna M Nair. All rights reserved.</p>
          </div>

          {/* Quick links / Social profiles */}
          <div className="flex items-center space-x-6 text-slate-400">
            <a href="https://github.com" target="_blank" rel="noreferrer" className="hover:text-sky-400 transition-colors">GitHub</a>
            <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="hover:text-sky-400 transition-colors">LinkedIn</a>
          </div>

          {/* Back to top button */}
          <button 
            onClick={() => scrollToSection("home")}
            className="p-2 rounded-lg bg-slate-900 border border-slate-800 text-slate-400 hover:text-sky-400 hover:border-sky-500/30 transition-all text-xs flex items-center gap-1"
          >
            Top ↑
          </button>
